...
const Profile = () => {
    ...
    return (
        ...
        <Card>
            <Title level={2} style={{ textAlign: 'center', marginBottom: '24px' }}> Мой профиль </Title>
            ...
            <Button type="primary" danger block onClick={handleLogout}>Выйти из аккаунта</Button>
        </Card>
    </div>
    )
}
